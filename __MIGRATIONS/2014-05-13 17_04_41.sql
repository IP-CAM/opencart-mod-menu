...
-- Dumping data for table opencart_dev.menu: ~0 rows (приблизно)
DELETE FROM `menu`;
...
-- Dumping data for table opencart_dev.menu_items: ~119 rows (приблизно)
...
-- Dumping data for table opencart_dev.menu_items_lang: ~116 rows (приблизно)
